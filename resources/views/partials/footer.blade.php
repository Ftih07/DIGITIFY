    <footer id="tentang-saya" class="bg-white border-t border-slate-100 py-16 md:py-20">
        <div class="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-[1fr,2fr] gap-12 items-center">
            <div class="text-center md:text-left">
                ...
                <div class="flex flex-col md:flex-row items-center gap-4 md:gap-6 mb-8">
                    <img src="{{ asset('logo.png') }}" alt="Naufal Fathi Portrait"
            ...
            <div class="text-center">
                <a href="https://wa.me/6281226110988?text={{ urlencode('Halo Naufal / Digitify! Saya ingin konsultasi mengenai digitalisasi bisnis dan pembuatan website. Boleh dibantu infonya?') }}"
                    target="_blank"
                    class="inline-block bg-[#FF8323] text-white px-10 py-5 rounded-full font-bold text-xl hover:bg-[#e6731f] transition duration-200 shadow-xl mb-12 transform hover:-translate-y-1">MULAI
                    PROYEK BERSAMA KAMI</a>

                <div class="grid grid-cols-1 sm:grid-cols-3 gap-6 text-center text-gray-800">
                    <div class="flex flex-col items-center gap-2">
                        <svg class="w-6 h-6 text-[#FF8323]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div
            ...
            <div class="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-2 text-sm font-medium">
                <a href="{{ route('game-services.index') }}" class="text-gray-500 hover:text-[#FF8323] transition">Game
                    Services</a>
